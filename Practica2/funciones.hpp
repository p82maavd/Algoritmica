...
void tiemposOrdenacionExtraQuickSort(int nMin, int n,int nMax, int repeticiones, int incremento, vector <double> &tiemposReales, vector <double> &numeroElementos);
